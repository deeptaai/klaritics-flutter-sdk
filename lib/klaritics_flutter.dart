...
import 'package:klaritics_flutter/klaritics_widget.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:flutter/services.dart';

typedef KlariticsDeeplinkListener = void Function(String? url);

/// Configuration used to initialize the Klaritics SDK from Dart.
///
/// ```dart
/// final config = KlariticsConfig('<your_app_id>');
/// config.host = 'https://your.klaritics.host';
/// await KlariticsFlutter.setup(config);
/// ```
class KlariticsConfig {
  KlariticsConfig(this.appId);

  /// The Klaritics application id from your dashboard.
  final String appId;

  /// The Klaritics backend host. Required on both Android and iOS; `setup`
  /// fails with an error if this is null or empty.
  String? host;
}
...
class KlariticsFlutter {
  static const MethodChannel klariticsMethodChannel =
      MethodChannel('plugins.flutter.io/klaritics_flutter');

  static bool _isInitialized = false;

  static KlariticsDeeplinkListener? _deeplinkListener;
  ...
  static void apxorJsMessageHandler(String message) {
    ...
    switch (method) {
      case "ActionEvent":
        KlariticsFlutter.logAppEvent(data["eventName"],
      ...
      case "AppEvent":
        ...
        break;
      case "ClientEvent":
        KlariticsFlutter.logClientEvent(data["eventName"],
            attributes: data["attributes"]);
        break;
      case "RedirectTo":
        ...
        KlariticsFlutter._logInternalEvent("apx_redirection",
            attributes: {"url": url});
        break;
      case "UpdateFlag":
        KlariticsFlutter._logInternalEvent("update_flag", attributes: data);
        break;
      case "UpdateCount":
        KlariticsFlutter._logInternalEvent("update_count", attributes: data);
        break;
    }
  }
  ...
  static bool _init() {
    BasicMessageChannel<dynamic> channel = const BasicMessageChannel(
        "plugins.flutter.io/klaritics_commands", JSONMessageCodec());
        ...
        case "d":
          {
            ...
            klariticsMethodChannel.invokeMethod("dr", <String, dynamic>{
              'r': d,
              't': message["t"],
            });
            break;
        ...
        case "f":
          {
            ...
            if (layout != null) {
              ...
              if (target != null && target.po != null) {
                klariticsMethodChannel.invokeMethod("fr", <String, dynamic>{
                  'r': {
                    't': target.po!.top,
                    'l': target.po!.left,
                    'b': target.po!.bottom,
        ...
        case "avf":
          {
            ...
            String rootElement = message["root_element"] ?? "";
            LT? layout = await _g(f: true, rootElement: rootElement);
            klariticsMethodChannel.invokeMethod("avf", <String, dynamic>{
              'r': layout?.toJ(d),
              't': message["t"],
            });
            break;
  ...
  static Future<void> setup(KlariticsConfig config) async {
    _ensureInitialized();
    if (!_isValidString(config.appId) || !_isValidString(config.host)) {
      print('Error: Klaritics cannot be initialized: `appId` and `host` cannot be null or empty in `setup`');
      return;
    }
    await klariticsMethodChannel.invokeMethod('setup', <String, dynamic>{
      'appId': config.appId,
      'host': config.host,
    });
  }
  ...
  static void logAppEvent(String eventName,
    ...
    if (_isValidString(eventName)) {
      klariticsMethodChannel.invokeMethod('logAppEvent',
  ...
  static void logClientEvent(String eventName,
    ...
    _ensureInitialized();
    if (_isValidString(eventName)) {
      klariticsMethodChannel.invokeMethod('logClientEvent',
          <String, dynamic>{'name': eventName, 'attrs': attributes});
    } else {
  ...
  static void _logInternalEvent(String eventName,
    ...
    _ensureInitialized();
    if (_isValidString(eventName)) {
      klariticsMethodChannel.invokeMethod('logInternalEvent',
          <String, dynamic>{'name': eventName, 'attrs': attributes});
    } else {
  ...
  static void setUserAttributes(Map<String, dynamic> attributes) {
    _ensureInitialized();
    klariticsMethodChannel.invokeMethod(
  ...
  static void setDeeplinkListener(KlariticsDeeplinkListener callback) {
    _ensureInitialized();
  ...
  static Future<String?> getDeviceId() async {
    _ensureInitialized();
    return await klariticsMethodChannel.invokeMethod('getDeviceId');
  }

  static Future<dynamic> getAttributes(List<String> attributes) async {
    _ensureInitialized();
    return await klariticsMethodChannel
  ...
  static void setTabController(TabController controller) {
    controller.addListener(() {
      if (controller.previousIndex != controller.index) {
        klariticsMethodChannel.invokeMethod('rm');
      }
    });
  }
    ...
    try {
      ...
      if (r != null) {
        ...
        if (findRenderObject != null) {
          ...
          print("app is not wrapped with KlariticsWidget");
        }
      } else {
