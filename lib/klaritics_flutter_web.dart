...
@JS()
library klaritics_flutter_web_plugin;
import 'dart:js';
...
/// Configuration used to initialize the Klaritics SDK. See the mobile
/// implementation for details; on web the SDK is loaded via the injected
/// `window.Apxor` script, so [KlariticsFlutter.setup] is a no-op.
...
class KlariticsFlutter {
  ...
  /// On web the Klaritics SDK is loaded via the injected `window.Apxor`
  /// script, so this is a no-op provided for API parity with mobile.
